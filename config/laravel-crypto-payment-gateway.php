...
return [
     ...
     * Example 2: [App\Http\Controllers\PaymentController::class, 'ipn']
     */
    'hook_ipn' => [\Victorybiz\LaravelCryptoPaymentGateway\Http\Controllers\CryptoPaymentController::class, 'ipn'],
