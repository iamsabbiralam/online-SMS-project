                    ...
                    <div class="card-body">                   
                        ...
                        <form action="{{ route('admin.country-store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input id="country" name="country" type="text" class="form-control" aria-required="true" aria-invalid="false" required>
                            </div> 
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input id="flag" name="flag" type="file" class="form-control"  aria-required="true" aria-invalid="false" required>
                            </div>
